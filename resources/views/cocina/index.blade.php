<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @forelse($ordenes as $orden)
                    <div class="bg-white p-6 rounded-lg shadow-md border-l-4 {{ $orden->estado === 'en espera' ? 'border-yellow-500' : 'border-blue-500' }} hover:shadow-lg transition-all">
    ...
    <script>
        function abrirModal(orden) {
            ...
            document.getElementById('modalEstado').innerText = orden.estado;
